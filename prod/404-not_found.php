<?php
define('PAGE','erreur_404');
$metatitle = "Krm-web, The digitale Team | Erreur 404 : Not found";
		...
		<div class="container">
			...
			<div class="row content">
				<div class="col-md-12">
					...
					<p class="text-center">This page has not been found ...<br><a href="http://krm-web.com">Go back to home page</a></p>					
				</div>
			</div>
		</div>
	</div>
