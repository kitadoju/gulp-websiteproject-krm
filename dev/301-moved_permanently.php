<?php
define('PAGE','erreur_301');
$metatitle = "Krm-web, The digitale Team | Erreur 301 : Moved permanently";
		...
		<div class="container">
			...
			<div class="row content">
				<div class="col-md-12">
					...
					<p class="text-center">This page has been moved permanently ...<br><a href="http://krm-web.com">Go back to home page</a></p>					
				</div>
			</div>
		</div>
	</div>
